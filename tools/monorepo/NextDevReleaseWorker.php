...
final class NextDevReleaseWorker implements ReleaseWorkerInterface
{
    /**
     * @var ProcessRunner
     */
    ...
    public function work(Version $version): void
    {
        ...
        $gitAddCommitCommand = sprintf(
            'git add . && git commit --allow-empty -m "open %s"',
            $versionInString
        );
    ...
    public function getDescription(Version $version): string
    {
        ...
        return sprintf('Commit next "%s" open', $versionInString);
    }
